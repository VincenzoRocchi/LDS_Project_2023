...
# Read geography data
geography_data = []
with open(r'..\DATA\Geography.csv', 'r') as file:
...
with open(r'..\DATA\dict_partecipant_age.json', 'r') as age_file, \
     open(r'..\DATA\dict_partecipant_status.json', 'r') as status_file, \
     open(r'..\DATA\dict_partecipant_type.json', 'r') as type_file, \
     open(r'..\DATA\Gun.csv', 'r') as gun_csv, \
     open(r'..\DATA\Participant.csv', 'r') as participant_csv, \
     open(r'..\DATA\Date.csv', 'r') as date_csv:
    ...
    with open(r'..\DATA\Police.csv', 'r') as csv_file, \
         open(r'..\DATA\Custody.csv', 'w', newline='') as custody_csv:
