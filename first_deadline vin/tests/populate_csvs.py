...
if __name__ == '__main__':
    ...
    # Create a cache dictionary to store already processed locations
    location_cache = {}
    ...
    with open('DATA/Police.csv', 'r') as csv_file:
        ...
        for row in csv_reader:
            ...
            if (latitude, longitude) in location_cache:
                location = location_cache((latitude, longitude),)
            else:
                # Reverse geocode to get city, state, and continent
                try:
                    location = rg.search((latitude, longitude),)
                    # Add the location to the cache
                    location_cache[(latitude, longitude)] = location
                except IndexError:
                    ...
                    try:
                        ...
                        print("Error: geocode failed on custody_id %s on row %s with error %s" % (custody_id, row, error))
