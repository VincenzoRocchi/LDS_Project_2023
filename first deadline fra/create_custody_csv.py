...
with open('DATA/dict_partecipant_age.json', 'r') as age_file, \
     ...
     open('Date.csv', 'r') as date_csv, \
     open('Incident.csv', 'r') as incident_csv:
    ...
    with open('Police.csv', 'r') as csv_file, \
        open('Custody.csv', 'w', newline='') as custody_csv:

        csv_reader = csv.reader(csv_file)
        custody_writer = csv.writer(custody_csv)
        custody_csv.truncate(0)
        ...
        for row in tqdm(csv_reader):
            ...
            if custody_id not in custody_id_set:
                ...
                crime_gravity = calculate_crime_gravity(participant_age_group, participant_type, participant_status, age_data, type_data, status_data)
